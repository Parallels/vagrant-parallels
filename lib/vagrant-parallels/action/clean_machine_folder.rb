...
module VagrantPlugins
  module Parallels
    module Action
      # Cleans up the Parallels machine folder for any ".xml-prev"
      # files which Parallels may have left over. This is a bug in
      # Parallels. As soon as this is fixed, this middleware can and
      # will be removed.
