...
module VagrantPlugins
  module Parallels
    module Action
      # This middleware class sets up all networking for the Parallels
      ...
      class Network
        ...
        def call(env)
          ...
          env[:machine].config.vm.networks.each do |type, options|
            ...
            if !slot
              if available_slots.empty?
                raise Vagrant::Errors::ParallelsNoRoomForHighLevelNetwork
              end
          ...
          network_adapters_config.each do |slot, data|
            ...
            # Get the Parallels adapter configuration
        ...
        def hostonly_config(options)
          ...
          # traffic onto the real interface rather than the Parallels
          # interface.
